  ...
  const templates = [
    {
      ...
      body: `Bonjour {nom},\n\nJ'espère que vous allez bien!\n\nJe suis ravi(e) de vous annoncer que notre nouvelle campagne de financement scolaire vient de commencer! Comme l'année dernière, nous vendons de délicieux produits de fournisseurs 100% québécois via Jappuie.ca pour soutenir notre école.\n\nVous avez été si généreux(se) l'année dernière et j'aimerais beaucoup compter sur votre soutien encore cette fois-ci! 🍰\n\nVous pouvez commander directement sur ma boutique en ligne:\n{lien}\n\nMerci infiniment pour votre soutien continu!\n\nCordialement,`
    },
    {
