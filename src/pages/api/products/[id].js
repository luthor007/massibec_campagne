...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      let { name, description, price, cost, image, isDefault, productId, ingredientsImage, nutritionImage, attributes } = req.body;

      // Check if this is a partial update (only attributes)
