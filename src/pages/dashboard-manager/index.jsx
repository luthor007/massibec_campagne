            ...
            >
              ...
              <CardContent className="pb-2">
                  ...
                  <div>
                      ...
                      {(school.totalRaised || 0).toLocaleString()}$
                    </h2>
                  ...
                  <div className="text-right">
                      ...
                      {(school.objectifFinancier || 0).toLocaleString()}$
                    </p>
                          <p className="text-sm text-gray-500 mt-1">
                            {(((school.objectifFinancier || 0) - (school.totalRaised || 0)) / 1000).toFixed(0)}k$ restants
                    </p>
                  </div>
                      </div>
                ...
                <Progress
                        ...
                        <div className="flex justify-between text-xs text-gray-500">
                          <span>0$</span>
                          <span>{(school.objectifFinancier || 0).toLocaleString()}$</span>
                        </div>
                      </div>
                    </div>
