...
export default function Exemple({ initialProducts }) {
    ...
    const storeDescription = "Voici un exemple de boutique pour vous donner une idée de ce à quoi ressemble une boutique Massibec. Vous pouvez parcourir les produits et ajouter des articles au panier, mais les commandes ne peuvent pas être passées dans cette boutique exemple."
                ...
                <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-blue-800">
                            Cette boutique est un exemple pour vous montrer à quoi ressemble une boutique Massibec. Vous pouvez parcourir les produits et ajouter des articles au panier, mais les commandes ne peuvent pas être passées dans cette boutique exemple.
                        </p>
                    </div>
                </div>
            </div>
